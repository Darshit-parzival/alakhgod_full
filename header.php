...
<html lang="en">
  ...
  <body>
    <div class="container text-center mt-3 mb-3">
        <a href="index.html" class="god-link-home">God</a>
    </div>
    <hr class="my-3">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">God’s Mantra</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">God’s Book</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">God’s Healing Photo</a>
                    </li>
                    <li class="nav-item dropdown">
