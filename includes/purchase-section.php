        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-primary"
                        onclick="addToCart('<?= $language ?> Domestic Book', 200, '<?= $language ?>_domesticQty', 5)">Add to cart</button>
                </td>
            </tr>
            ...
            <?php if ($language === 'english' || $language === 'hindi'): ?>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary"
                            onclick="addToCart('<?= $language ?> International Book', 4000, '<?= $language ?>_intlQty', 2)">Add to cart</button>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary"
                            onclick="addToCart('<?= $language ?> Ebook', 200, '<?= $language ?>_ebookQty', 1)">Add to cart</button>
                    </td>
                </tr>

                <!-- POD with Amazon Links -->
                <tr>
                    <td>POD (Print on Demand)</td>
                    <td>—</td>
                    <td>—</td>
                    <td>
