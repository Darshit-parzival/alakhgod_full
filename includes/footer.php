        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <div class="d-flex gap-3">
                    <a href="https://www.facebook.com/AlakhGod" target="_blank" class="foot-font" title="Facebook">
                        <i class="bi bi-facebook fs-4"></i>
                    </a>
                    <a href="https://x.com/AlakhGod" target="_blank" class="foot-font" title="Twitter">
                        <i class="bi bi-twitter fs-4"></i>
                    </a>
                    <a href="https://www.instagram.com/AlakhGod/" target="_blank" class="foot-font" title="Instagram">
                        <i class="bi bi-instagram fs-4"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/AlakhGod" target="_blank" class="foot-font" title="LinkedIn">
                        <i class="bi bi-linkedin fs-4"></i>
                    </a>
                    <a href="https://www.youtube.com/@AlakhGod" target="_blank" class="foot-font" title="YouTube">
