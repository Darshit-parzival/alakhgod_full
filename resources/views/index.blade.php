        ...
        <div class="container flex-grow-1 d-flex flex-column justify-content-start align-items-center mt-5">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-7 col-md-8 col-sm-12 text-left">
                    ...
                    <div class="mt-3 text-content text-justify">
                        <h3 class="index-heading text-justify">“May the Grace of Goddess & God Heal Your Pain and Suffering“</h3>
                        <h4 class="mt-5 index-font text-justify">You are welcome to the space of Goddess and God.</h4>

                        <p class="mt-4 index-font text-justify" style="text-align: justify;">
                ...
                <div class="container text-center mt-5 mb-5">
                    ...
                    <div class="d-flex flex-wrap justify-content-center mt-4">
                        ...
                        <div class="info-box">
                            <h4>My Book</h4>
                            <p style="text-align: justify;">Until August 2023, you had to attend a 3-day workshop by My Messenger, Pradip Mukherji, to
                        ...
                        <div class="info-box">
                            <h4>God’s Healing</h4>
                            <p style="text-align: justify;">Talk to the above Photo about your suffering, pain, problems, issues, negativity, confusion,
