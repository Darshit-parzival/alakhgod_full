                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="aboutDropdown">
                            <li><a class="dropdown-item" href="/About-Pradip-Sir/Journey-To-God/">My Journey TO God</a>
                            </li>
                            <li><a class="dropdown-item" href="/About-Pradip-Sir/Journey-With-God/">My Journey WITH
                                    God</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Gods-Mantra">God’s Mantra</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="bookDropdown">
                            <li><a class="dropdown-item" href="/Gods-Book/About">About</a></li>
                            <li><a class="dropdown-item" href="/Gods-Book/Order">Order</a></li>
                            <li><a class="dropdown-item" href="/Gods-Book/Read">Read</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Gods-Healing-Photo">God’s Healing Photo</a>
                    </li>
                    <li class="nav-item dropdown">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="othersDropdown">
                            <li><a class="dropdown-item" href="/Others/Contact">Contact Us</a></li>
                            <li><a class="dropdown-item" href="/Others/FAQ">FAQ (Frequently Asked Questions)</a></li>
